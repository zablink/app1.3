...
async function verifyData() {
    try {
        ...
        const activeSubsByTier = await prisma.$queryRaw `
    ...
    `;
        ...
        const freeShops = await prisma.$queryRaw `
